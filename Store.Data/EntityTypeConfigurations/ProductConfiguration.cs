...
namespace Store.Data
{
    ...
    public class ProductConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Product>
    {
        ...
        public ProductConfiguration(string schema)
        {
            ...
            Property(x => x.ProductImageName).HasColumnName(@"ProductImageName").HasColumnType("nvarchar").IsOptional().HasMaxLength(70);
            Property(x => x.ProductImageMimeType).HasColumnName(@"ProductImageMimeType").HasColumnType("nvarchar").IsOptional().HasMaxLength(15);
